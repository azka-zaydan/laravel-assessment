...
const POSTMAN_DOCS_URL =
	"https://documenter.getpostman.com/view/21013457/2sBXqFM2oa";
			...
			<header className="border-b bg-white/70 dark:bg-slate-950/70 backdrop-blur">
				<div className="max-w-6xl mx-auto px-6 py-14 md:py-20">
					...
					<p className="mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
						A RESTful Laravel 13 API powering a Telegram bot — restaurant search,
						nearby discovery, reviews, menus, and rich message-type handling —
						with JWT/Passport auth, TOTP 2FA, PostgreSQL persistence, Redis
						caching, and a React admin log viewer.
					</p>
